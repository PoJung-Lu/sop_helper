...
APP_TITLE = "SOP_Helper MVP v0.9.8"
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # QLabel 顯示 QPixmap 後 sizeHint 會被圖片實際尺寸撐大，導致外層 QSplitter 無法再縮小該面板；
        # 明確限制最小尺寸為 1x1，讓 QSplitter 的拖曳調整不受目前顯示圖片大小影響。
    ...
    def save_project(self):
        ...
        if path:
            data = {"project_version":"0.9.8", "source_image":self.image_path, "annotations":[asdict(a) for a in self.annotations], "components":[asdict(c) for c in self.components]}
