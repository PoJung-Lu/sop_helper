...
class MainWindow(QMainWindow):
    ...
    def on_component_item_pressed(self, item):
        ...
        if row == self._last_pressed_component_row and item.isSelected():
    ...
    def save_project(self):
        ...
        if path:
            data = {"project_version":"0.9", "source_image":self.image_path, "annotations":[asdict(a) for a in self.annotations], "components":[asdict(c) for c in self.components]}
