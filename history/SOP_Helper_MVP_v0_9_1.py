...
APP_TITLE = "SOP_Helper MVP v0.9.1"
...
class MainWindow(QMainWindow):
    ...
    def save_project(self):
        ...
        if path:
            data = {"project_version":"0.9.1", "source_image":self.image_path, "annotations":[asdict(a) for a in self.annotations], "components":[asdict(c) for c in self.components]}
